...
| 版本 | 状态 | 阶段数 | 完成 | 摘要 |
|------|------|--------|------|------|
| [v0.5.0](v0.5.0/plan.md) | 已归档 | 1 | 1/1 done | 框架级记忆体系 |
| [v0.5.1](v0.5.1/ops/op-001.md) | 已归档 | 1 | 1/1 done | 工具链内化与一致性治理 |
| [v0.5.2](v0.5.2/ops/op-001.md) | 已归档 | 1 | 1/1 done | 职责迁移与 Agent 协作原语 |
| [v0.5.3](v0.5.3/ops/op-001.md) | 已归档 | 1 | 1/1 done | 状态持久化与灵活流程控制 |
| [v0.5.4](v0.5.4/ops/op-001.md) | 已归档 | 1 | 1/1 done | 质量保障与知识库健康 + CLI-Agent 对齐 |
| [v0.5.5](v0.5.5/ops/op-001.md) | 已归档 | 1 | 1/1 done | 缺陷修复（部署传播 + autoCommitOnDone 时序） |
| [v0.5.6](v0.5.6/ops/op-001.md) | 已归档 | 1 | 1/1 done | 版本管理规范 + manual 模块文档 + reasoning_effort |
| v0.5.7 | 已归档 | 1 | 1/1 done | 计划目录重构 + reasoning_effort 调整 |
| [v0.5.8](v0.5.8/ops/op-001.md) | 已归档 | 1 | 1/1 done | 三项缺陷修复（映射修正 + 模板补节 + manual 目录） |
| [v0.5.9](v0.5.9/ops/op-001.md) | 已归档 | 1 | 1/1 done | 审查纪律强化（feel/executor 硬性纪律） |
| [v0.5.10](v0.5.10/ops/op-001.md) | 已归档 | 2 | 2/2 done | profile 自动填充 + 异常安全修复 |
| [v0.5.11](v0.5.11/ops/op-001.md) | 已归档 | 1 | 1/1 done | 目录归位 + 版本号重映射 + 新规则 |

> 系列路线图：[roadmap-v5](roadmap-v5.md)（由 v0.4.7 迁入）

## 各期摘要

### v0.5.11：目录归位 + 版本号重映射 + 新规则 ✅ 已归档
