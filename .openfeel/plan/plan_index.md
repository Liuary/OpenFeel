...
### [OpenFeel v5 — 工具链 + 协作增强 + 质量保障](v4.7/roadmap-v5.md)

**目标**：v5.0 框架级记忆体系，v5.1 CLI 内化归档 git commit + 提示词统一，v5.2 Handoff 原语 + 规范迁移，v5.3 Checkpoint 快照 + 组合终止条件，v5.4 lint i18n + kb 健康 + CLI-Agent 对齐。5 期 12 项任务。

| 阶段 | 任务 | 优先级 | 状态 |
|------|------|:--:|:--:|
| v5.0 | 框架级记忆体系（全局 profile + 项目记忆卡片，3 项） | P1 | ⬜ |
| v5.1 | 工具链内化与一致性治理（2 项） | P1 | ⬜ |
| v5.2 | 职责迁移与 Agent 协作原语（2 项） | P1 | ⬜ |
| v5.3 | 状态持久化与灵活流程控制（2 项） | P1 | ⬜ |
| v5.4 | 质量保障与知识库健康 + CLI-Agent 对齐（3 项） | P1 | ⬜ |
