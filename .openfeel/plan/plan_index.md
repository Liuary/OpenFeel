...
**目标**：v5.0 CLI 内化归档 git commit + 提示词统一，v5.1 Handoff 原语 + 规范迁移，v5.2 Checkpoint 快照 + 组合终止条件，v5.3 lint i18n + kb 健康检测。4 期 8 项任务。

| 阶段 | 任务 | 优先级 | 状态 |
|------|------|:--:|:--:|
| v5.0 | 工具链内化与一致性治理（2 项） | P1 | ⬜ |
| v5.1 | 职责迁移与 Agent 协作原语（2 项） | P1 | ⬜ |
| v5.2 | 状态持久化与灵活流程控制（2 项） | P1 | ⬜ |
| v5.3 | 质量保障与知识库健康（2 项） | P1 | ⬜ |
